...
class acf_media_cluster_field extends acf_field {
	...
	*  __construct
	*
	*  This function will setup the field type data for ACF version 6
	*
	*  @type	function
	*  @date	4/23/2023
	*  @since	1.2.3
...
/*
 *  acf_mc_render_field_settings_v6()
 *
 ...
 *  @return	n/a
 */
function acf_mc_render_field_settings_v6( $field )
{
    $name = $field['name'];
    $value = $field['acf_mc_force_download'];
...
add_action('acf/render_field_general_settings/type=media_cluster', 'acf_mc_render_field_settings_v6');
